...
/**
 * The base model implementation for the Weather service. Represents a row in the &quot;Weatherdb_Weather&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class WeatherModelImpl extends BaseModelImpl<Weather>
     ...
     */
    public static final String TABLE_NAME = "Weatherdb_Weather";
    public static final Object[][] TABLE_COLUMNS = {
            ...
            {"searchParamCity", Types.VARCHAR},
            {"searchParamDate", Types.TIMESTAMP},
    ...
    public static final String TABLE_SQL_CREATE = "create table Weatherdb_Weather (weatherId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,searchParamCity VARCHAR(75) null,searchParamDate DATE null,source VARCHAR(75) null,city VARCHAR(75) null,country VARCHAR(75) null,lat DOUBLE,lon DOUBLE,condition_ VARCHAR(75) null,avgTemp DOUBLE,minTemp DOUBLE,maxTemp DOUBLE,date_ DATE null)";
    public static final String TABLE_SQL_DROP = "drop table Weatherdb_Weather";
    public static final String ORDER_BY_JPQL = " ORDER BY weather.searchParamCity ASC";
    public static final String ORDER_BY_SQL = " ORDER BY Weatherdb_Weather.searchParamCity ASC";
    ...
    public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(edu.efimovta.liferay.osgi.db.weather.service.util.ServiceProps.get(
            ...
            true);
    public static final long SEARCHPARAMCITY_COLUMN_BITMASK = 1L;
    public static final long SEARCHPARAMDATE_COLUMN_BITMASK = 2L;
    ...
    static {
        ...
        TABLE_COLUMNS_MAP.put("searchParamCity", Types.VARCHAR);
        TABLE_COLUMNS_MAP.put("searchParamDate", Types.TIMESTAMP);
    ...
    private String _originalSearchParamCity;
    private Date _searchParamDate;
    private Date _originalSearchParamDate;
    ...
    public static Weather toModel(WeatherSoap soapModel) {
        ...
        model.setSearchParamCity(soapModel.getSearchParamCity());
        model.setSearchParamDate(soapModel.getSearchParamDate());
    ...
    public void setSearchParamCity(String searchParamCity) {
        ...
        if (_originalSearchParamCity == null) {
            _originalSearchParamCity = _searchParamCity;
        }

        _searchParamCity = searchParamCity;
    }

    public String getOriginalSearchParamCity() {
        return GetterUtil.getString(_originalSearchParamCity);
    }
    ...
    public void setSearchParamDate(Date searchParamDate) {
        _columnBitmask |= SEARCHPARAMDATE_COLUMN_BITMASK;

        if (_originalSearchParamDate == null) {
            _originalSearchParamDate = _searchParamDate;
        }

        _searchParamDate = searchParamDate;
    }

    public Date getOriginalSearchParamDate() {
        return _originalSearchParamDate;
    }
    ...
    public Object clone() {
        ...
        weatherImpl.setSearchParamCity(getSearchParamCity());
        weatherImpl.setSearchParamDate(getSearchParamDate());
    ...
    public int compareTo(Weather weather) {
        ...
        value = getSearchParamCity().compareTo(weather.getSearchParamCity());
    ...
    public void resetOriginalValues() {
        ...
        weatherModelImpl._originalSearchParamCity = weatherModelImpl._searchParamCity;

        weatherModelImpl._originalSearchParamDate = weatherModelImpl._searchParamDate;
    ...
    public CacheModel<Weather> toCacheModel() {
        ...
        weatherCacheModel.searchParamCity = getSearchParamCity();

        String searchParamCity = weatherCacheModel.searchParamCity;

        if ((searchParamCity != null) && (searchParamCity.length() == 0)) {
            weatherCacheModel.searchParamCity = null;
        }

        Date searchParamDate = getSearchParamDate();

        if (searchParamDate != null) {
            weatherCacheModel.searchParamDate = searchParamDate.getTime();
        } else {
            weatherCacheModel.searchParamDate = Long.MIN_VALUE;
        }
    ...
    public String toString() {
        ...
        sb.append(getSearchParamCity());
        sb.append(", searchParamDate=");
        sb.append(getSearchParamDate());
        sb.append(", source=");
        sb.append(getSource());
        sb.append(", city=");
        sb.append(getCity());
    ...
    public String toXmlString() {
        ...
        sb.append("]]></column-value></column>");
        sb.append(
                "<column><column-name>searchParamCity</column-name><column-value><![CDATA[");
        sb.append(getSearchParamCity());
        sb.append("]]></column-value></column>");
        sb.append(
                "<column><column-name>searchParamDate</column-name><column-value><![CDATA[");
        sb.append(getSearchParamDate());
        sb.append("]]></column-value></column>");
        sb.append(

...
public class WeatherLocalServiceWrapper implements WeatherLocalService,
    ...
    @Override
    public void add(java.lang.String city, java.util.Date date,
                    edu.efimovta.liferay.osgi.weather.dto.Weather weather) {
        _weatherLocalService.add(city, date, weather);
	}
